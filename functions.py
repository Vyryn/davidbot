...
recruiter_role = (
    261396521805807617  # This is actually HR. Recruiter: 376500752203644928
)
...
divs = {
    ...
    "finance": "business",
    "trade": "business",
    "space security": "security",
    "ground security": "security",
    "repo": "security",
...
welcome_david_msg = (
    "Welcome {author} to the Corporation! I'm David. Please join The Corporation on RSI. Once your"
...
understand_david_msg = (
    "Great. Now I know you can understand me :smiley:\nCan you **__please post your RSI handle__**"
...
statuses = [
    "The Elevator to success is currently out of order, you will have to take the stairs.",
    ...
    async def user_auth_check(ctx, *args):
        for uid in bot_commanders.keys():
            if (
                ...
                and bot_commanders.get(uid, default_auth) >= level
            ):
                return True
